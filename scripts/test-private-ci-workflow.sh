...
content_contracts=(
  ...
  "$live_workflow|test-web-live-talk-live|LIVE_TALK_BASE_URL: \${{ vars.LIVE_TALK_BASE_URL || (vars.LIVE_TALK_API_FORMAT == 'vertex' && 'https://us-central1-aiplatform.googleapis.com') || '' }}"
  ...
  "$live_workflow|test-web-live-talk-live|LIVE_TALK_VERTEX_LOCATION: \${{ vars.LIVE_TALK_VERTEX_LOCATION || 'us-central1' }}"
